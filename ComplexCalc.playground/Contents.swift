...
class Calculator {
    // ADDITION
    func add(lhs n1: Int, rhs n2: Int) -> Int {
        return n1 + n2
    }
    ...
    // SUBTRACT
    func subtract(lhs n1: Int, rhs n2: Int) -> Int {
        return n1 - n2
    }
    ...
    // MATH OPS
    // runs operation function on given lhs and rhs
    func mathOp(lhs: Int, rhs: Int, op: (Int, Int) -> Int) -> Int {
        return op(lhs, rhs)
    }
    
    // beg: starting value; op: operation function
